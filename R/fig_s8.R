# fig_s8.R
# Fig S8: BP (s8a) and MF (s8b) of the GO terms of the top 10% specifically expressed genes in the top 25 clusters
...
reducedTerms.top25.MF <- reduceSimMatrix(simMatrix.top25.MF,
                                         ...
                                         orgdb="org.Hs.eg.db")
# plot
pdf(file = here("workflow/figures/s8a_treeMapBP_SCZtop25.pdf"))
treemapPlot(reducedTerms.top25.BP)
dev.off()
pdf(file = here("workflow/figures/s8b_treeMapMF_SCZtop25.pdf"))
